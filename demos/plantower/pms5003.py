...
class PlanTower(object):
    ...
    def __init__(self):
        ...
        #self.uart2 = machine.UART(2, baudrate=9600, rx=17, tx=16, timeout=10000)
        self.count = 0
        self.clear_sums()
    ...
    def print_avr_results(self):
        ...
        print('PM 1.0 concentration (CF = 1, standard particle): {:f} ug/m3'.format(self.pm1_0_std_sum/self.count))
        print('PM 2.5 concentration (CF = 1, standard particle): {:f} ug/m3'.format(self.pm2_5_std_sum/self.count))
        print('PM 10  concentration (CF = 1, standard particle): {:f} ug/m3'.format(self.pm10_std_sum/self.count))

        print('PM 1.0 concentration (under atmospheric environment): {:f} ug/m3'.format(self.pm1_0_atm_sum/self.count))
        print('PM 2.5 concentration (under atmospheric environment): {:f} ug/m3'.format(self.pm2_5_atm_sum/self.count))
        print('PM 10  concentration (under atmospheric environment): {:f} ug/m3'.format(self.pm10_atm_sum/self.count))

        print('No of particle with diameter beyond 0.3 um in 0.1L of air: {:f}'.format(self.beyond_0_3_sum/self.count))
        print('No of particle with diameter beyond 0.5 um in 0.1L of air: {:f}'.format(self.beyond_0_5_sum/self.count))
        print('No of particle with diameter beyond 1.0 um in 0.1L of air: {:f}'.format(self.beyond_1_0_sum/self.count))
        print('No of particle with diameter beyond 2.5 um in 0.1L of air: {:f}'.format(self.beyond_2_5_sum/self.count))
        print('No of particle with diameter beyond 5.0 um in 0.1L of air: {:f}'.format(self.beyond_5_0_sum/self.count))
        print('No of particle with diameter beyond 10  um in 0.1L of air: {:f}'.format(self.beyond_10_sum/self.count))
        
    def sum(self):
        # average results over 1 min
        self.pm1_0_std_sum += self.pm1_0_std
        self.pm2_5_std_sum += self.pm2_5_std
        self.pm10_std_sum  += self.pm10_std

        self.pm1_0_atm_sum += self.pm1_0_atm
        self.pm2_5_atm_sum += self.pm2_5_atm
        self.pm10_atm_sum  += self.pm10_atm

        self.beyond_0_3_sum += self.beyond_0_3
        self.beyond_0_5_sum += self.beyond_0_5
        self.beyond_1_0_sum += self.beyond_1_0
        self.beyond_2_5_sum += self.beyond_2_5
        self.beyond_5_0_sum += self.beyond_5_0
        self.beyond_10_sum  += self.beyond_10

        self.count += 1

    def clear_sums(self):
        self.pm1_0_std_sum = 0
        self.pm2_5_std_sum = 0
        self.pm10_std_sum  = 0

        self.pm1_0_atm_sum = 0
        self.pm2_5_atm_sum = 0
        self.pm10_atm_sum  = 0

        self.beyond_0_3_sum = 0
        self.beyond_0_5_sum = 0
        self.beyond_1_0_sum = 0
        self.beyond_2_5_sum = 0
        self.beyond_5_0_sum = 0
        self.beyond_10_sum  = 0
    ...
    def results(self):
        res = {
            ...
            "beyond_0_3":self.beyond_0_3,
            "beyond_0_5":self.beyond_0_5,
    ...
    def avr_results(self):
        avr_res = {
            ...
            "pm2_5_std_avr":self.pm2_5_std_sum/self.count,
            "pm10_std_avr":self.pm10_std_sum/self.count,
            "pm1_0_atm_avr":self.pm1_0_atm_sum/self.count,
            "pm2_5_atm_avr":self.pm2_5_atm_sum/self.count,
            "pm10_atm_avr":self.pm10_atm_sum/self.count,
            "beyond_0_3_avr":self.beyond_0_3_sum/self.count,
            "beyond_0_5_avr":self.beyond_0_5_sum/self.count,
            "beyond_1_0_avr":self.beyond_1_0_sum/self.count,
            "beyond_2_5_avr":self.beyond_2_5_sum/self.count,
            "beyond_5_0_avr":self.beyond_5_0_sum/self.count,
            "beyond_10_avr":self.beyond_10_sum/self.count
        }
        return avr_res
